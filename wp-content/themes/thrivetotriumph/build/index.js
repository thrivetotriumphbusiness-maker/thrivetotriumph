...
{}
  ...
  instagramWrapperItems.forEach(function (instagramWrapperItem) {
    var token = 'IGQWROLXF6d1l6anM0WU81SkhHdDFsSkZAUNS1xTHdPSm1naXR3UkQzd01jczR6X1Q4cGdsdTVVMjRUX3NNc0RMOTRZAbVdQSjdpMUZAxYjNpc1puc18ycDI1eUZAoaUlxSm5TbW0tOExiUDVpMm12T0hLai10MUxqanMZD',
      ...
      // how much photos do you want to get
  ...
  function initScrollNavigate() {
    ...
    if (!$('header').hasClass('no-sticky')) {
      if (scrollPos >= headerHeight) {
        ...
        if (!$('.header-top-bar').is(':hidden')) {
          $('.header-top-bar').css({
            'top': '-' + (miniHeaderHeight + wpAdminBarHeight) + 'px'
          });
    ...
    if (scrollPos < headerHeight) {
      ...
      setTimeout(function () {
        ...
        const navbarTop = 0;
        $('.navbar').css({
          'top': wpAdminBarHeight + miniHeaderHeight
        });
        // if ($('.header-top-bar').length) {
        //     if(siteLocalData.is_admin_bar_show){
        //         wpAdminBarHeight = $('#wpadminbar').outerHeight();
...
class IconManager {
  constructor() {
    this.feature_box_el = document.querySelectorAll(".icon-manager .feature-box");
    this._init();
  }
  _init() {
      ...
      if (document.getElementById(this.nav_cookie)) {
        ...
        switch (this.nav_cookie) {
          case "service":
            ...
            $('header .nav-item:has(a.nav-link[data-target="service"])').addClass("active");
            break;
        }
      }
    });
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _assets_css_responsive_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../assets/css/responsive.css */ "./assets/css/responsive.css");
/* harmony import */ var _assets_css_template_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../assets/css/template.css */ "./assets/css/template.css");
...
/* harmony import */ var _assets_js_main__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../assets/js/main */ "./assets/js/main.js");
/* harmony import */ var _assets_js_main__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_assets_js_main__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _nav__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./nav */ "./src/nav.js");
/* harmony import */ var _icon_manager__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./icon-manager */ "./src/icon-manager.js");
...
const iconManager = new _icon_manager__WEBPACK_IMPORTED_MODULE_5__["default"]();
})();
